...
ExternalProject_Add(
  ...
  CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${COMMON_DDS_DESTINATION} -DCMAKE_PREFIX_PATH=${COMMON_DDS_DESTINATION} -DBUILD_SHARED_LIBS=OFF -DCMAKE_CXX_FLAGS="-fPIC" -DCMAKE_C_FLAGS="-fPIC"
)
